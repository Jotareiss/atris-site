# Cards dos médicos — copy final

Framework espartano: kicker + nome + linha de cargo (com glosa) + linha de formação/pesquisa + registro + botão.
Afiliação carrega a especialidade; glosa traduz o jargão; foto carrega o acolhimento. Sem datas, sem pós-nominal, sem prosa de clima.

---

Psiquiatra
Dra. Lara Zancaner Ueta
Médica assistente no HCRP-USP, responsável pela interconsulta psiquiátrica — transtornos mentais associados a doenças físicas — e pelo serviço de esquizofrenia e reabilitação psicossocial.
Formada em medicina pela PUC-Campinas. Psiquiatra pelo HCRP-USP. Mestre em saúde mental pela FMRP-USP, com foco em neuroimagem na esquizofrenia.
